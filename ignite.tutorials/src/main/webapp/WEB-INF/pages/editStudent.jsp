...
<h1 align="center">Edit Student</h1><br>
<c:url var="action" value="save_changes/STU${RollNo}" ></c:url>
<form:form method="post" action="${action}" modelAttribute="student">
    <table>
   
  <c:if test="${not empty user.rollNo}">
    <tr>
        <td>
        ...
        <td>
            <form:input path="rollNo" readonly="true" size="10"  disabled="true" />
