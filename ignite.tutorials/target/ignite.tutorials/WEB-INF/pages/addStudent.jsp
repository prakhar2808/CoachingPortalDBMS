...
<h2>${title}</h2>
<h2>${message}</h2>
<c:url var="action" value="/admin/students_portal/add/STU" ></c:url>
...
<table>
    ...
    <tr>
		<td>Guardian :</td>
		<td>
			<form:select path="guardianId" required="required">
		  		<form:options items="${guardians}" itemValue="guardianId" itemLabel="representation" />
	       	</form:select>
        </td>
	</tr>
    <tr>
