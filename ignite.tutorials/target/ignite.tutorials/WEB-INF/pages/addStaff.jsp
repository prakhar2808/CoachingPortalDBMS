...
<h2>${title}</h2>
<h2>${message}</h2>
<c:url var="action" value="/admin/staff_portal/add/STA" ></c:url>
<form:form method="post" action="${action}" modelAttribute="staff" >
<table>
	<tr>
    ...
    <tr>
        <td><form:label type="date" path="dob">DOB</form:label></td>
        <td><form:input path="dob" placeholder="YYYY-MM-DD" required="required"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><form:input path="job" required="required" /> </td>
    </tr>
    <tr>
