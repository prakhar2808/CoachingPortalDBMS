...
<h2>Edit Student</h2>
<c:url var="action" value="save_changes/STA${StaffId}" ></c:url>
<form:form method="post" action="${action}" modelAttribute="staff">
    <table>
   
  <c:if test="${not empty user.staffId}">
    <tr>
        <td>
            <form:label path="staffId">
                Roll No
            </form:label>
        </td>
        
        <td>
            <form:input path="staffId" readonly="true" size="10"  disabled="true" />
